...
#SBATCH --output=/mnt/weka/hminasyan/logs/dinat_motion_defocus_%j.log
#SBATCH --error=/mnt/weka/hminasyan/logs/dinat_motion_defocus_%j.err
...
: "${OUTPUT_DIR:=/mnt/weka/hminasyan/finetune_motion_blur_runs/deblurdinat_motion_defocus_512}"
: "${PYTHON:=/mnt/weka/hminasyan/deblurdinat_env/bin/python3}"

# Hyperparameters kept aligned with blur finetuning style
...
echo "================================================================"
echo "DeblurDiNAT + frozen DUSt3R (motion/defocus synthetic blur)"
echo "================================================================"
echo "Started     : $(date)"
echo "Host        : $(hostname)"
...
echo "Freeze      : ${FREEZE}"
echo "Motion prob : ${MOTION_PROB} (defocus prob is 1-motion_prob)"
echo "Train split : ${SPLIT_TRAIN}"
echo "Split style : sample-level random split (val=${VAL_RATIO}, test=${TEST_RATIO})"
echo "LR          : ${LR} (warmup=${WARMUP_EPOCHS}, eta_min=${ETA_MIN})"
