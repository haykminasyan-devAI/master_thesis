#!/bin/bash
#SBATCH --job-name=dust3r_exp4
#SBATCH --partition=a100
#SBATCH --gres=gpu:3
#SBATCH --cpus-per-task=12
#SBATCH --mem=96G
#SBATCH --time=06:00:00
#SBATCH --output=logs/exp4_%j.log
#SBATCH --error=logs/exp4_%j.err

# ── Configuration ─────────────────────────────────────────────────
SEQ_DIR="data/co3d/teddybear/101_11758_21048"
MASKED_DIR="outputs/masked_frames/teddybear/101_11758_21048/mask_50pct"
OUTPUT_DIR="outputs/dust3r/exp4"
N_FRAMES_MIN=2
N_FRAMES_MAX=40
MASK_RATIO=0.5
NUM_PATCHES=6
...
echo "mask_ratio : $MASK_RATIO  |  num_patches: $NUM_PATCHES"
echo "================================================================"
...
for N in $(seq $N_FRAMES_MIN $N_FRAMES_MAX); do
    ...
    # Wait once all 3 GPU slots are busy
...
python3 scripts/masking_exp/exp4.py \
    --exp3_dir      outputs/dust3r/exp3 \
    --exp4_dir      "$OUTPUT_DIR" \
